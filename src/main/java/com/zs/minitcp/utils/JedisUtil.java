...
public class JedisUtil {
    ...
    static {
        ...
        try {
            ...
            throw new RuntimeException("gaia.properties not found", e);
        }

        // 从配置文件中获取属性值
        JEDIS_IP = config.getString("minitcp.redis.host", "127.0.0.1");
        JEDIS_PORT = config.getInt("minitcp.redis.port", 6379);
        JEDIS_PASSWORD = config.getString("minitcp.redis.password", null);
